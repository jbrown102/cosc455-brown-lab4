package edu.towson.cosc.cosc455.jbrown102.lab4
...
class SyntaxAnalyzer {
  ...
  // This method implements the BNF rule for an article <A> ::= teh | a
  def Article() = {
  ...
  // This method implements the BNF rule for an adjective <A> ::= fat | hungry | happy | mean
  def Adjective() = {
  ...
  // This method implements the BNF rule for an adverb <A> ::= accidently | quickly | secretly
  def Adverb() = {
